...
# DOF_PERIOD <- 6  # AIC: 24290
DOF_PERIOD <- 5  # AIC: 24285
# DOF_PERIOD <- 4  # AIC: 24285
# DOF_PERIOD <- 3  # AIC: -3757023526 (abnormal! => changing knot fix this)
# knots = c(2015), Boundary.knots = c(2010, 2019)  # 24292
