...
subtitle: "Converting sf objects to spm"
author: "Maxwell"
date: '`r Sys.Date()`'
...
See the vignette vol.1: <https://lcgodoy.me/smile/articles/sf-to-spm.html>
...
p1 <- ggplot(data = liv_msoa) + 
    ...
    labs(title = "Estimated Life Expectancy at Birth", 
         subtitle = "(Liverpool LSOA dataset)") + 
    ...
    annotate(geom = "text", x = 336, y = 380, label = "@Maxwell_110",
...
p2 <- ggplot(data = liv_lsoa) + 
    ...
    labs(title = "Index of Multiple Deprivation", 
         subtitle = "(Liverpool MSOA dataset)", 
...
p1 + p2 + plot_layout(ncol = 2, widths = c(6, 5))
ggsave(filename = "fig/smile_01-1.jpg", width = 9, height = 5, dpi = 200)
```


# Create `spm` object from sf object to estimate Gaussian process
