...
# rgee GitHub: https://github.com/r-spatial/rgee#hello-world
# Examples for rgee: https://r-earthengine.com/
...
t.grob <- grid::rasterGrob(t.img, 
                           ...
                           height = unit(0.4, "cm"),
                           interpolate = FALSE)
rgee.img <- png::readPNG("fig/rgee_logo.png")
rgee.grob <- grid::rasterGrob(rgee.img, 
                              width = unit(0.4, "cm"),
                              height = unit(0.4, "cm"),
                              interpolate = FALSE)
