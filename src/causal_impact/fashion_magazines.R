...
p1 <- impact.res %>% 
  ...
  annotate("text", x = as.Date("2020-08-15"), y = 20000, 
           label = "COVID-19", color = "white", size = 5) +
  ...
  annotate("text", x = as.Date("2020-08-15"), y = 70000, 
           label = "point-wise impact and credible interval", 
           color = "violetred1", size = 2) +
  annotate("text", x = as.Date("2020-08-15"), y = 40000, 
           label = "obserbation", 
           color = "gray0", size = 2) +
...
ggsave("fig/fashion_magazines_02.png", width = 8, height = 8, dpi = 150)
