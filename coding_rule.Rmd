...
基本的には、  
[Hadley WickhamによるStyleguide](http://adv-r.had.co.nz/Style.html)と  
[google社で提案された規約](https://google-styleguide.googlecode.com/svn/trunk/Rguide.xml)  
をベースにします。  
...
```{r example_comment, echo = FALSE, message = FALSE}
library(rugarch)
